...
`{flashr}` can use existing built-in flashcard decks, including functions and arguments from [R for Data Science (first edition)](https://r4ds.had.co.nz/). <!--The aim is to include decks from [R for Data Science (second edition)](https://r4ds.hadley.nz) when it is complete.-->
...
> Stevens, Jeffrey R. (2022). flashr: Creates flashcards of terms and definitions. (version 0.0.1) https://github.com/JeffreyRStevens/flashr
